...
import donatioPage from "../../../public/donationPage.json";
...
const UpdateDonation = () => {
  ...
  return (
    <div className="h-[90vh] w-[65%] flex flex-col lg:flex-row items-center justify-center bg-white">
      {/* Left side: Lottie Animation */}
      <div className="w-full lg:w-1/2 mb-6 lg:mb-0">
        <Lottie
          animationData={donatioPage}
          loop
